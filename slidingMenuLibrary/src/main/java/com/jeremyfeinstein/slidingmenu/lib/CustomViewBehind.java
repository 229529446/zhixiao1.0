...
//				oldX = e.getX();
//				Log.i("behind", "onTouchEvent.down: **************dx="+dx+"*************x="+x+"************oldx="+oldX+"*********scrillX="+mViewAbove.getScrollX());
//				break;
//			case MotionEvent.ACTION_MOVE:
//				x = e.getX();
//				dx = (int)(oldX-x);
//				int newx = mViewAbove.getScrollX()+dx;
//
//				if (newx > 0) newx = 0;
//
//
//				if ( dx > 50){
//					mViewAbove.scrollTo(newx,getScrollY());
//				}
//				Log.i("behind", "onTouchEvent.move: **************dx="+dx+"*************x="+x+"************oldx="+oldX+"*********scrillX="+mViewAbove.getScrollX()+"**********newx="+newx);
//				break;
//			case MotionEvent.ACTION_UP:
////				if (dx>width/2){
////					mViewAbove.scrollTo(0,0);
////				}
//				break;
//
//		}
